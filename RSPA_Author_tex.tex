...
\begin{figure}
  ...
  \begin{tikzpicture}
  \begin{groupplot}[group style={group size=2 by 1,horizontal sep=40pt,every plot/.style={xmin=-5,xmax=0.3,ymin=0,ymax=3},xlabels at=edge bottom,vertical sep=30pt},width=7.1cm,height=7.5cm,xlabel={$\lambda$},x label style={at={(0.5,-0.1)}},scatter/classes={%
  		a={mark=*,mark size=2pt,blue},%
  		b={mark=o,mark size=2pt,red}},legend style={at={(0.33,0.95)}}]

  \nextgroupplot[title=(a),ylabel={Amplitude of LCO},y label style={at={(-0.05,0.5)}},legend style={at={(0.35,0.98)}},xmin=-0.3,xmax=5]
  ...
  \nextgroupplot[title=(b),ylabel={Amplitude of LCO},y label style={at={(-0.05,0.5)}}]
