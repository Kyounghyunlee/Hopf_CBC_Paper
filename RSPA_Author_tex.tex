...
\begin{align}\label{eq:6}
  ...
  \end{split}
\end{align}
Coefficients of \Eref{eq:6} can be computed recursively by solving the following equations \cite{yu2002simplest}:
\begin{align}\label{eq:7}
  ...
  \end{split}
\end{align}
where \(l(\vec{u})=\vec{J}_c\vec{u}\), \(\tilde h_2=[h_2;p_2]\), and \(\big[h_k,l\big]\) is Lie bracket defined as
\begin{align}\label{eq:8}
\big[h_k,l\big]=Dl\cdot h_k-Dh_k\cdot l.
\end{align}
Eliminating noncritical terms by applying \Eref{eq:6} transformation to \Eref{eq:7} and balancing every coefficient of power series, SNF of Hopf bifurcation is derived as
