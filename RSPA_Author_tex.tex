...
To apply CBC to more general Hopf bifurcation problems, frequency of the phase-locked periodic solutions in \Eref{eq:26} should be controllable. Also, a methodology to overcome the influence of the measurement noise should be considered to increase the accuracy of the CBC results. \vskip6pt
